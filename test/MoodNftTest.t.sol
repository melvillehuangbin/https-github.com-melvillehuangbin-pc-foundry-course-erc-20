...
contract MoodNftTest is Test {
    ...
    // testTokenURIDefaultIsCorrectlySet
    // testFlipTokenToSad
    // testEventRecordsCorrectTokenIdOnMinting

    DeployMoodNft deployer; // internal visibility
    MoodNft moodNft;
    ...
    function testInitializedCorrectly() public view {
        string memory nftName = "MoodNft";
        string memory nftSymbol = "MD";
    ...
    // make sure the default tokenURI is correctly set
    ...
    function testEventRecordsCorrectTokenIdOnMinting() public {
        uint256 currentlyAvailableTokenId = moodNft.getTokenCounter();
        ...
        uint256 tokenProto = uint256(entries[1].topics[1]);
        assert(currentlyAvailableTokenId == tokenProto);
    }
}
